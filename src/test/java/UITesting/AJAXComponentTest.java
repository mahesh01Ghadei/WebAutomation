...
public class AJAXComponentTest {
	public static void main(String [] args) {
		...
		Boolean isAjaxDataLoaded = ajaxElementWait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[@id='content']//p"), "Data loaded with AJAX get request."));
